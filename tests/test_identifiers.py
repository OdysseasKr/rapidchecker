...
def test_valid_identifier(valid_identifier: str):
...
def test_invalid_identifier(invalid_identifier: str):
...
def test_elem_index(index: str, expected: str | int):
...
def test_valid_variable(valid_variable: str):
...
def test_invalid_variable(invalid_variable: str):
    with pytest.raises(ParseException):
...
def test_parameter(valid_parameter: str):
